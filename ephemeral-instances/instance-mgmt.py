...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "Examples:\n"
            "  instance-mgmt.py add --instance test01 --file data.json\n"
            "  instance-mgmt.py add --instance app01 --type m5.large --os rhel9 --volume-size 500 --file data.json\n"
            "  instance-mgmt.py del --instance test01 --file data.json\n"
            "  instance-mgmt.py list --file data.json\n"
            "  instance-mgmt.py add --dry-run --keep-temp --instance test01 --file data.json\n"
        ),
    )
    subparsers = parser.add_subparsers(dest="command", required=True)

    add_parser = subparsers.add_parser("add", help="Add instance")
